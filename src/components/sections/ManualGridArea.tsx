...
export const ManualGridArea: React.FC = () => {
  ...
  return (
    <section id="grid" className="py-20 bg-stone-50 border-b border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 p-8 sm:p-12 bg-white relative overflow-hidden">
            <div className="flex items-center justify-between text-xs font-mono text-stone-500 mb-8 pb-2 border-b border-stone-200">
            ...
            <div className="p-12 sm:p-16 bg-stone-100/60 bg-manual-grid flex items-center justify-center relative">
              ...
              <div 
                className="relative border-2 border-dashed p-8 sm:p-12 bg-white/90 flex items-center justify-center"
              ...
              <div className="space-y-4 pt-2 text-xs">
                <div className="p-4 bg-stone-50 space-y-1">
                  <div className="flex justify-between font-mono font-bold text-stone-800">
                    ...
                    <span style={{ color: brand.colors.verdeMedio.hex }} className="font-bold">18 mm</span>
                  </div>
                ...
                <div className="p-4 bg-stone-50 space-y-1">
                  <div className="flex justify-between font-mono font-bold text-stone-800">
                    ...
                    <span style={{ color: brand.colors.verdeMedio.hex }} className="font-bold">32 px</span>
                  </div>
