...
export const ManualHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-sm text-stone-900 no-print">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-800 text-xs font-semibold transition-colors cursor-pointer"
          >
            <Download size={14} />
